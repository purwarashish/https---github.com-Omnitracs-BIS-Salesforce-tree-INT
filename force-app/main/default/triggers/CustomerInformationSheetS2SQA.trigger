trigger CustomerInformationSheetS2SQA on Customer_Information_Sheet__c (before insert,before update) {
        ...
        if(trigger.new[0].ConnectionReceivedId != null && trigger.new[0].ConnectionReceivedId == '04P3F000000007hUAA'){
            try{
                if(trigger.new[0].Implementation_Contact_Legacy_S2S__c != null && trigger.new[0].Implementation_Contact_Legacy_S2S__c != ''){
                    ...
                    prnc = [SELECT LocalRecordId FROM PartnerNetworkRecordConnection WHERE ConnectionId='04P3F000000007hUAA' AND Status='Received' AND PartnerRecordId=:trigger.new[0].Implementation_Contact_S2S__c LIMIT 1];
                    if(prnc.size()>0){
                ...
                if(trigger.new[0].Implementation_Contact_Legacy_S2S__c != null && trigger.new[0].Implementation_Contact_Legacy_S2S__c != ''){
                    ...
                    prnc = [SELECT LocalRecordId FROM PartnerNetworkRecordConnection WHERE ConnectionId='04P3F000000007hUAA' AND Status='Received' AND PartnerRecordId=:trigger.new[0].Installer_Contact_Id_S2S__c LIMIT 1];
                    if(prnc.size()>0){
                ...
                if(trigger.new[0].Primary_Contact_Legacy_S2S__c != null && trigger.new[0].Primary_Contact_Legacy_S2S__c != ''){
                    ...
                    prnc = [SELECT LocalRecordId FROM PartnerNetworkRecordConnection WHERE ConnectionId='04P3F000000007hUAA' AND Status='Received' AND PartnerRecordId=:trigger.new[0].Primary_Contact_S2S__c LIMIT 1];
                    if(prnc.size()>0){
